...
error_reporting(E_ALL);
        ...
        $item = !isset($_GET['item']) ? '' : strtoupper($_GET['item']);
        ...
        $query = "select G.ITEM, G.DSC, GS.COSTO, A.MONTO_AVANCE, G.TOTAL_INF, ROUND(A.MONTO_AVANCE*G.TOTAL_INF/G.TOTAL_INF,4) AVANCE, ROUND(A.MONTO_AVANCE/GS.COSTO,6) PORC_AVANCE, G.ORD
from GANTT2 as G
LEFT JOIN AVANCE_GANTT_SEG as A
ON G.ITEM = A.ITEM
LEFT JOIN GANTT_SEG as GS
ON G.ITEM = GS.ITEM
WHERE G.ITEM LIKE '".$item."%'
ORDER BY G.ORD
 ";
